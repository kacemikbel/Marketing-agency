    ...
    <div class="w-full max-w-lg bg-white rounded-lg shadow-2xl p-8 m-4 animate__animated animate__fadeIn" style="animation: slideInFromLeft 1s ease-out;">
        ...
        <form  method="post" action="./php/recruit.php"  enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex items-center justify-center bg-grey-lighter">
                <label class="w-full flex flex-col items-center px-4 py-6 bg-white text-blue-500 rounded-lg shadow-lg tracking-wide uppercase border border-blue-500 cursor-pointer hover:bg-blue-500 hover:text-white transition duration-300 ease-in-out" style="animation: fadeIn 2s;">
                   
                    <span class="mt-2 text-base leading-normal font-semibold">Upload CV</span>
                    <input type='file' name="file" class="hidden" accept=".pdf,.doc,.docx"/>
                </label>
            </div>

        
            <div class="flex items-center justify-center bg-grey-lighter mt-4">
                <label class="w-full flex flex-col items-center px-4 py-6 bg-white text-green-500 rounded-lg shadow-lg tracking-wide uppercase border border-green-500 cursor-pointer hover:bg-green-500 hover:text-white transition duration-300 ease-in-out" style="animation: fadeIn 2.5s;">
            ...
            <div class="flex items-center justify-between">
                <button type="submit" class="w-full bg-gradient-to-r from-blue-400 to-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline hover:from-blue-500 hover:to-blue-700 transition duration-300 ease-in-out transform hover:-translate-y-1" type="submit">
                    Submit Application
                </button>
            </div>
        </form>
